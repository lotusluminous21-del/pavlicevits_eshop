...
export default function StorefrontLayout({
    ...
    // marketing brand homepage doesn't pay the ~250KB cost of importing
    // firebase/auth + firestore + functions + reactfire just to render
    // five sections of static content.
    return (
        <FirebaseProvider>
            <AuthProvider>
                <div className={cn(
